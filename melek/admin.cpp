...
void admin::on_tabetudiant_activated(const QModelIndex &index)
{
    ...
    qry.prepare("select * from compte where nom = '"+nom+"' or prenom ='"+nom+"' or nomcom ='"+nom+"' or mdp ='"+nom+"' or daate ='"+nom+"' or statut ='"+nom+"'");
    if (qry.exec())
    {
        while(qry.next())
        {
...
void admin::on_tabetudiant_clicked(const QModelIndex &index)
{
    ...
    qry.prepare("select * from compte where nom = '"+nom+"' or prenom ='"+nom+"' or nomcom='"+nom+"' or mdp ='"+nom+"' or statut ='"+nom+"'");
    if (qry.exec())
    {
        while(qry.next())
        {
